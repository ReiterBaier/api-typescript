...
var plataform_1 = require("../../../entities/plataform");
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, databaseConnection_1.AppDatasource.manager.find(plataform_1.Plataform)];
    });
}); };
...
var findOne = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                param = { where: [{ id: id }] };
                return [4 /*yield*/, databaseConnection_1.AppDatasource.manager.findOne(plataform_1.Plataform, param)];
            case 1:
                client = _a.sent();
