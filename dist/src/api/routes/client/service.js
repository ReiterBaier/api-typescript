...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, databaseConnection_1.AppDatasource.manager.find(client_1.Client)];
    });
}); };
...
var findOne = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                param = { where: [{ id: id }] };
                return [4 /*yield*/, databaseConnection_1.AppDatasource.manager.findOne(client_1.Client, param)];
            case 1:
                client = _a.sent();
